...
class Server:
    ...
    def collect_MetaData(self, users):
        ...
        while i < Limit:
            ...
            OriginMetaX = torch.Tensor(OriginMetaX)
            TempMetaX = torch.Tensor(TempMetaX)

            OriginMetaY = torch.Tensor(OriginMetaY)
            TempMetaY = torch.Tensor(TempMetaY)
